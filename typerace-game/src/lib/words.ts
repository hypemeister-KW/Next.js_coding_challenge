export const WORD_LIST = [
  ...
  'but', 'from', 'or', 'which', 'one', 'would', 'all', 'will', 'there', 'say', 'who',
  ...
  'possible', 'head', 'consider', 'word', 'program', 'problem', 'however',
...
export const INITIAL_WORDS: string[] = [...WORD_LIST.slice(0, 45)]
